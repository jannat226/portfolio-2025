  ...
  return (
    <div className="section py-8 flex flex-col items-center justify-center w-full mx-auto">
      ...
      <div className="main-color leading-relaxed text-gray-700 dark:text-gray-200 text-base sm:text-lg lg:text-xl space-y-6 max-w-2xl mx-auto text-justify">
        ...
        <p>
          From optimizing <span className="font-semibold text-purple-600 dark:text-purple-400">biomedical data pipelines</span> to building intuitive analytics tools.<br />
          I love turning complex ideas into real-world solutions.<br />
          When I&apos;m not coding, you&apos;ll find me exploring new tech or playing tennis — where, unlike debugging, the ball usually plays fair.
        </p>
      </div>
    </div>
  );
