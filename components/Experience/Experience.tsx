  ...
  return (
    ...
    >
      ...
      <div className="text-left mb-6 sm:mb-8">
        <h4 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 dark:text-gray-200 mb-4 sm:mb-6">
          ...
          <div className="relative mb-8">
            {/* Timeline line */}
            <div className="absolute top-20 left-6 right-6 h-1 bg-gradient-to-r from-blue-400 via-blue-400 to-green-400 dark:from-blue-300 dark:via-blue-300 dark:to-green-300 rounded-full shadow-lg"></div>
                    ...
                    <div key={idx} className="flex-shrink-0 w-80 relative">
                      ...
                      <div className={`absolute top-6 left-1/2 transform -translate-x-1/2 px-3 py-1 rounded-full text-xs font-semibold shadow-md whitespace-nowrap ${
                        experience.date?.includes("Present") 
                          ...
                          : "bg-gradient-to-r from-blue-100 to-blue-100 dark:from-blue-900 dark:to-blue-900 text-blue-800 dark:text-blue-300"
                      }`}>
                        {experience.date?.includes("Present") ? (
                          <span>
