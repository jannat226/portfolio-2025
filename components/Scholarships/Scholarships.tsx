...
const scholarships = [
    {
        ...
        detail:
            "Center for Microbiome Engineering & Data Analysis (cMEDA), Virginia Commonwealth University. Awarded to support a summer biomedical project in collaboration with Dr. Bridget T. McInnes.",
    },
];
