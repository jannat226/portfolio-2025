      ...
      >
        ...
        <ParallaxWrapper speed={0.4}>
          <ScrollAnimation className="w-full" direction="scale">
            <div id="home" className="flex items-center justify-center px-4 sm:px-6 lg:px-8 pb-8">
              <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-6 py-6 transition-colors duration-300 relative z-10 w-full">
                <Header />
        ...
        <ParallaxWrapper speed={0.3}>
          <ScrollAnimation className="w-full" direction="up" delay={0.2}>
            <div id="experience" className="flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8">
              <Experience />
            </div>
          </ScrollAnimation>
        </ParallaxWrapper>
        ...
        <ParallaxWrapper speed={0.5}>
          <ScrollAnimation className="w-full" direction="left" delay={0.1}>
            <div id="projects" className="flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8">
              <Projects />
            </div>
          </ScrollAnimation>
        </ParallaxWrapper>
        ...
        <ScrollAnimation className="w-full" direction="up" delay={0.3}>
          <div id="techstack" className="flex items-center justify-center px-4 sm:px-6 lg:px-8 py-4">
            <TechStack />
          </div>
        </ScrollAnimation>
        
        <ScrollAnimation className="w-full" direction="scale" delay={0.2}>
          <div id="contact" className="flex items-center justify-center px-4 sm:px-6 lg:px-8 py-4">
